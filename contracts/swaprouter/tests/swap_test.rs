...
use swaprouter::msg::{ExecuteMsg, SwapType};
use test_env::*;
...
test_swap!(
    ...
    msg = ExecuteMsg::Swap {
        ...
        swap_type: SwapType::MinOutputAmount(1u128.into()),
    },
    funds: [
        Coin::new(1000, "uosmo")
    ]
...
test_swap!(
    ...
    msg = ExecuteMsg::Swap {
        input_coin: Coin::new(1000, "uosmo"),
        output_denom: "uion".to_string(),
        swap_type: SwapType::MinOutputAmount(1000000000000000000000000u128.into()),
    },
    funds: [
        Coin::new(1000, "uosmo")
    ]
...
test_swap!(
    ...
    msg = ExecuteMsg::Swap {
        input_coin: Coin::new(1000, "uosmo"),
        output_denom: "uion".to_string(),
        swap_type: SwapType::MaxPriceImpactPercentage(Decimal::from_str("5").unwrap()),
    },
    funds: [
